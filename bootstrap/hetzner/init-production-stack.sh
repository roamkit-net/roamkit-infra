...
copy_from_local() {
  ...
  cp "${INFRA_ROOT}/scripts/production-dod-airalo-phase7.sh" "${STACK_DIR}/scripts/production-dod-airalo-phase7.sh"
  cp "${INFRA_ROOT}/scripts/phase7-airalo-preflight.sh" "${STACK_DIR}/scripts/phase7-airalo-preflight.sh"
...
if [[ -f "${INFRA_ROOT}/docker/docker-compose.production.yml" ]]; then
  ...
  cp "${TMP_DIR}/scripts/production-dod-airalo-phase7.sh" "${STACK_DIR}/scripts/production-dod-airalo-phase7.sh"
  cp "${TMP_DIR}/scripts/phase7-airalo-preflight.sh" "${STACK_DIR}/scripts/phase7-airalo-preflight.sh"
