...
copy_from_local() {
  ...
  cp "${INFRA_ROOT}/scripts/staging-dod-faza2.sh" "${STACK_DIR}/scripts/staging-dod-faza2.sh"
  cp "${INFRA_ROOT}/scripts/staging-dod-billing.sh" "${STACK_DIR}/scripts/staging-dod-billing.sh"
  cp "${INFRA_ROOT}/scripts/staging-dod-airalo-phase5.sh" "${STACK_DIR}/scripts/staging-dod-airalo-phase5.sh"
  cp "${INFRA_ROOT}/scripts/staging-dod-airalo-phase6-pilot.sh" "${STACK_DIR}/scripts/staging-dod-airalo-phase6-pilot.sh"
  cp "${INFRA_ROOT}/scripts/staging-pause-airalo.sh" "${STACK_DIR}/scripts/staging-pause-airalo.sh"
...
if [[ -f "${INFRA_ROOT}/docker/docker-compose.staging.yml" ]]; then
  ...
  cp "${TMP_DIR}/scripts/staging-dod-faza2.sh" "${STACK_DIR}/scripts/staging-dod-faza2.sh"
  cp "${TMP_DIR}/scripts/staging-dod-billing.sh" "${STACK_DIR}/scripts/staging-dod-billing.sh"
  cp "${TMP_DIR}/scripts/staging-dod-airalo-phase5.sh" "${STACK_DIR}/scripts/staging-dod-airalo-phase5.sh"
  cp "${TMP_DIR}/scripts/staging-dod-airalo-phase6-pilot.sh" "${STACK_DIR}/scripts/staging-dod-airalo-phase6-pilot.sh"
  cp "${TMP_DIR}/scripts/staging-pause-airalo.sh" "${STACK_DIR}/scripts/staging-pause-airalo.sh"
